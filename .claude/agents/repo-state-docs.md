...
- `CHANGELOG.md` holds completed/verified work, decisions, and durable project rules (past/imperative tense).
- `OPEN_GAPS.md` holds unfinished work, open problems, and priorities (present tense; name the next decisive action).
- `TOMBSTONES.md` holds dead ends, refuted hypotheses, and blocked avenues (why abandoned; where surviving knowledge lives).
