...
TRAINING_FUNCS="id32 add2 umax umin abs_diff gray_code avg_floor \
       ...
       to_sbyte to_shalf shift_r shift_l rotate_right ctz_nonzero bswap32 add_high_carry mul_high_u32 mul_imm addr_calc scale8 nand \
       ...
       isqrt collatz_steps signed_loop_branch"
